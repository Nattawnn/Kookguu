    ...
    <main>
      <form action="" className="flex flex-col ">
        <input
          ...
          maxLength={12}
          required
          className="text-center text-black bg-gray-100 mt-20 p-4 px-14 mb-5 mx-8 rounded-xl"
        />
        <input
          type="text"
          id="password"
          ...
          required
          className="text-center bg-gray-100 mt-1 p-4 px-14 mx-8 rounded-xl"
        />
